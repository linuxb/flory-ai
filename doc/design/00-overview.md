...
- **PostgreSQL** holds both event planes, harness metadata, business-state snapshots, synchronous transaction projections, and work queues, and allocates per-run and per-entity write order.
